...
START TRANSACTION;
USE `greymatterpi`;
INSERT INTO `greymatterpi`.`narudzbenica` (`idNarudzbenice`, `oibKlijenta`, `datumIzdavanja`, `oibZaposlenika`, `rokPlacanja`) VALUES (NULL, '48651234578', '2014-30-5', '14579564124', '2014-30-6');
INSERT INTO `greymatterpi`.`narudzbenica` (`idNarudzbenice`, `oibKlijenta`, `datumIzdavanja`, `oibZaposlenika`, `rokPlacanja`) VALUES (NULL, '84578412344', '2014-31-5', '14579564124', '2014-31-6');
...
START TRANSACTION;
USE `greymatterpi`;
INSERT INTO `greymatterpi`.`lijek` (`idLijek`, `naziv`, `upute`, `datumProizvodnje`, `rokUpotrebe`, `cijena`, `pakiranje`, `doza`, `idJedinicnaMjera`, `idTipLijeka`, `kolicina`) VALUES (NULL, 'Lopin', 'Lijek za glavu', '2014-29-5', '2016-29-5', 37.99, 30, 5, 1, 3, 5000);
INSERT INTO `greymatterpi`.`lijek` (`idLijek`, `naziv`, `upute`, `datumProizvodnje`, `rokUpotrebe`, `cijena`, `pakiranje`, `doza`, `idJedinicnaMjera`, `idTipLijeka`, `kolicina`) VALUES (NULL, 'Ibuprofen Farmal', 'Lijek za glavu', '2014-20-5', '2016-20-5', 69.99, 30, 200, 1, 3, 7500);
INSERT INTO `greymatterpi`.`lijek` (`idLijek`, `naziv`, `upute`, `datumProizvodnje`, `rokUpotrebe`, `cijena`, `pakiranje`, `doza`, `idJedinicnaMjera`, `idTipLijeka`, `kolicina`) VALUES (NULL, 'Ibuprofen Farmal', 'Lijek za glavu', '2014-20-5', '2016-20-5', 99.99, 30, 400, 1, 3, 7500);
INSERT INTO `greymatterpi`.`lijek` (`idLijek`, `naziv`, `upute`, `datumProizvodnje`, `rokUpotrebe`, `cijena`, `pakiranje`, `doza`, `idJedinicnaMjera`, `idTipLijeka`, `kolicina`) VALUES (NULL, 'Ibuprofen Farmal', 'Lijek za glavu', '2014-20-5', '2016-20-5', 119.99, 30, 600, 1, 3, 5000);
